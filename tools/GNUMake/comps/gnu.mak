...
ifeq ($(DEBUG),TRUE)
  ...
  CXXFLAGS += -Og -fno-inline -ggdb -Wall -Wshadow -Wno-sign-compare -ftrapv -Wno-unused-but-set-variable
  CFLAGS   += -Og -fno-inline -ggdb -Wall -Wshadow -Wno-sign-compare -ftrapv
