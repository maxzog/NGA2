...
module lpt_class
  ...
  type :: lpt
   ...
   contains
     ...
     procedure :: wall_collide_jkr                       !< Evaluate particle-wall collision force - JKR  
...
contains
 ...
 subroutine wall_collide_cundall(this,p,dt)
   ...
   collision_force: block
     ...
     if (isOverlap) then
        ...
        k_n=real(100E+06,WP)
        k_t=real(100E+06,WP)
        k_n=Pi**2 / this%tau_col**2
        k_t=Pi**2 / this%tau_col**2
        eta_n = 0.0_WP 
        eta_t = 0.0_WP 
        ! Normal collision
 ...
 subroutine wall_collide_jkr(this,p,dt)
   implicit none
   class(lpt) , intent(inout) :: this
   class(part), intent(inout) :: p
   real(WP), intent(inout) :: dt  !< Timestep size over which to advance
 ...
 end subroutine wall_collide_jkr
