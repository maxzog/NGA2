...
!      counter_=0.0_WP
   ...
   subroutine simulation_init
      ...
      allocate_work_arrays: block
         ...
         allocate(S_(  cfg%imino_:cfg%imaxo_,cfg%jmino_:cfg%jmaxo_,cfg%kmino_:cfg%kmaxo_)); S_  =0.0_WP 
      ...
      create_ensight: block
         ...
         call ens_out%add_vector('filtered_velocity',Uif,Vif,Wif)
         call ens_out%add_vector('sub_velocity',Uis,Vis,Wis)
