...
<<<<<<< HEAD:src/solver/pfft3d_class.f90
    ...
    do k = this%cfg%kmin_, this%cfg%kmax_
       do j = this%cfg%jmin_, this%cfg%jmax_
          do i = this%cfg%imin_, this%cfg%imax_
             if (any(abs(this%opr(:,i,j,k)-ref_stencil(:)).gt.1000.0_WP*epsilon(1.0_WP))) circulent = .false.
          end do
       end do
    end do
...
>>>>>>> master:src/solver/fourier3d_class.f90
