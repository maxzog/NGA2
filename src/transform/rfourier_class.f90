...
!> Makes use of real to real FFTW and in-house parallel transpose operations.
!>
...
contains
   ...
   subroutine xtranspose_forward(this,A,At)
      ...
      case ('y')
         ...
         call MPI_AllToAll(this%sendbuf_x,this%sendcount_x,MPI_REAL_WP,this%recvbuf_x,this%recvcount_x,MPI_REAL_WP,this%pg%xcomm,ierr)
         do ip=1,this%pg%npx
            do k=this%pg%kmin_,this%pg%kmax_
   ...
   subroutine ytranspose_forward(this,A,At)
      ...
      case ('x')
         ...
         call MPI_AllToAll(this%sendbuf_y,this%sendcount_y,MPI_REAL_WP,this%recvbuf_y,this%recvcount_y,MPI_REAL_WP,this%pg%ycomm,ierr)
         do jp=1,this%pg%npy
            do k=this%pg%kmin_,this%pg%kmax_
   ...
   subroutine ztranspose_forward(this,A,At)
      ...
      case ('x')
         ...
         call MPI_AllToAll(this%sendbuf_z,this%sendcount_z,MPI_REAL_WP,this%recvbuf_z,this%recvcount_z,MPI_REAL_WP,this%pg%zcomm,ierr)
         do kp=1,this%pg%npz
   ...
   subroutine xtransform_forward(this,A)
      ...
      implicit none
      class(rfourier), intent(inout) :: this
      real(WP), dimension(this%pg%imin_:,this%pg%jmin_:,this%pg%kmin_:), intent(inout) :: A         !< Needs to be (imin_:imax_,jmin_:jmax_,kmin_:kmax_)
      integer :: j,k
      include 'fftw3.f03'
      ! Check availability of fft in x
      if (.not.this%xfft_avail) call die('[rfourier] Fourier transform is not available in x')
   ...
   subroutine ytransform_forward(this,A)
      ...
      if (.not.this%yfft_avail) call die('[rfourier] Fourier transform is not available in y')
      ! Nothing to do if single cell
   ...
   subroutine ztransform_forward(this,A)
      ...
      if (.not.this%zfft_avail) call die('[rfourier] Fourier transform is not available in z')
      ! Nothing to do if single cell
